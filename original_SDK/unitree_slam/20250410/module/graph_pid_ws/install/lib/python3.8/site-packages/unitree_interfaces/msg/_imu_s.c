...
bool unitree_interfaces__msg__imu__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("unitree_interfaces.msg._imu.IMU", full_classname_dest, 31) == 0);
  }
  unitree_interfaces__msg__IMU * ros_message = _ros_message;
  {  // quaternion
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * unitree_interfaces__msg__imu__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of IMU */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("unitree_interfaces.msg._imu");
  ...
  unitree_interfaces__msg__IMU * ros_message = (unitree_interfaces__msg__IMU *)raw_ros_message;
  {  // quaternion
    PyObject * field = NULL;
