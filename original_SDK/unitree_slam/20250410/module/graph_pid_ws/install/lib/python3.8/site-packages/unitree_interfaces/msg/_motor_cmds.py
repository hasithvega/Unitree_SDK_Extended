    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'unitree_interfaces.msg.MotorCmds')
            logger.debug(
            ...
            from unitree_interfaces.msg import MotorCmd
...
class MotorCmds(metaclass=Metaclass_MotorCmds):
    ...
    _fields_and_field_types = {
        'motor_cmd': 'unitree_interfaces/MotorCmd[20]',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.Array(rosidl_parser.definition.NamespacedType(['unitree_interfaces', 'msg'], 'MotorCmd'), 20),  # noqa: E501
    )
