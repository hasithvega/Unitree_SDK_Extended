...
bool custom_interface__msg__nav_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("custom_interface.msg._nav_state.NavState", full_classname_dest, 40) == 0);
  }
  custom_interface__msg__NavState * ros_message = _ros_message;
  {  // id
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * custom_interface__msg__nav_state__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of NavState */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("custom_interface.msg._nav_state");
  ...
  custom_interface__msg__NavState * ros_message = (custom_interface__msg__NavState *)raw_ros_message;
  {  // id
    PyObject * field = NULL;
