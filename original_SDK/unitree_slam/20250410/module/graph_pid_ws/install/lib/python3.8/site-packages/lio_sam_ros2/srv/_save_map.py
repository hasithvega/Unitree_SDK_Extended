...
class Metaclass_SaveMap_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('lio_sam_ros2')
        except ImportError:
            import logging
            import traceback
...
class Metaclass_SaveMap(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from lio_sam_ros2.srv import _save_map
...
class SaveMap(metaclass=Metaclass_SaveMap):
    from lio_sam_ros2.srv._save_map import SaveMap_Request as Request
    from lio_sam_ros2.srv._save_map import SaveMap_Response as Response
