...
#ifndef UNITREE_INTERFACES__MSG__DETAIL__MOTOR_STATE__FUNCTIONS_H_
#define UNITREE_INTERFACES__MSG__DETAIL__MOTOR_STATE__FUNCTIONS_H_
 ...
 * calls
 * unitree_interfaces__msg__MotorState__init().
...
/**
 * It calls
 * unitree_interfaces__msg__MotorState__fini()
 ...
 * unitree_interfaces__msg__MotorState__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * unitree_interfaces__msg__MotorState__Sequence__fini()
 * on the array,
...
#endif  // UNITREE_INTERFACES__MSG__DETAIL__MOTOR_STATE__FUNCTIONS_H_
