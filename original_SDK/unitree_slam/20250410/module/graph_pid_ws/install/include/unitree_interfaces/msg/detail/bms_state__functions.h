...
#ifndef UNITREE_INTERFACES__MSG__DETAIL__BMS_STATE__FUNCTIONS_H_
#define UNITREE_INTERFACES__MSG__DETAIL__BMS_STATE__FUNCTIONS_H_
 ...
 * calls
 * unitree_interfaces__msg__BmsState__init().
...
/**
 * It calls
 * unitree_interfaces__msg__BmsState__fini()
 ...
 * unitree_interfaces__msg__BmsState__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * unitree_interfaces__msg__BmsState__Sequence__fini()
 * on the array,
...
#endif  // UNITREE_INTERFACES__MSG__DETAIL__BMS_STATE__FUNCTIONS_H_
