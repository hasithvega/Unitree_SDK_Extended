...
#include <stddef.h>
#include "nav2_costmap/msg/detail/cost_map__rosidl_typesupport_introspection_c.h"
#include "nav2_costmap/msg/rosidl_typesupport_introspection_c__visibility_control.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  nav2_costmap__msg__CostMap__init(message_memory);
}

void CostMap__rosidl_typesupport_introspection_c__CostMap_fini_function(void * message_memory)
{
  nav2_costmap__msg__CostMap__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember CostMap__rosidl_typesupport_introspection_c__CostMap_message_member_array[6] = {
  {
    "header",  // name
    ...
    offsetof(nav2_costmap__msg__CostMap, header),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(nav2_costmap__msg__CostMap, resolution),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(nav2_costmap__msg__CostMap, size_x),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(nav2_costmap__msg__CostMap, size_y),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(nav2_costmap__msg__CostMap, origin),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(nav2_costmap__msg__CostMap, data),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers CostMap__rosidl_typesupport_introspection_c__CostMap_message_members = {
  "nav2_costmap__msg",  // message namespace
  "CostMap",  // message name
  6,  // number of fields
  sizeof(nav2_costmap__msg__CostMap),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_nav2_costmap
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, nav2_costmap, msg, CostMap)() {
  CostMap__rosidl_typesupport_introspection_c__CostMap_message_member_array[0].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, std_msgs, msg, Header)();
  CostMap__rosidl_typesupport_introspection_c__CostMap_message_member_array[4].members_ =
