...
if("TRUE" STREQUAL "TRUE")
  set(minkindr_conversions_SOURCE_PREFIX /unitree/module/Odometer_service/src/minkindr_ros/minkindr_conversions)
  set(minkindr_conversions_DEVEL_PREFIX /unitree/module/Odometer_service/devel/.private/minkindr_conversions)
  ...
  set(minkindr_conversions_INSTALL_PREFIX /unitree/module/Odometer_service/install)
...
if(NOT "/unitree/module/Odometer_service/src/minkindr_ros/minkindr_conversions/include " STREQUAL " ")
  set(minkindr_conversions_INCLUDE_DIRS "")
  set(_include_dirs "/unitree/module/Odometer_service/src/minkindr_ros/minkindr_conversions/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'minkindr_conversions' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/unitree/module/Odometer_service/src/minkindr_ros/minkindr_conversions/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /unitree/module/Odometer_service/devel/.private/minkindr_conversions/lib;/unitree/module/Odometer_service/devel/lib;/opt/ros/noetic/lib)
