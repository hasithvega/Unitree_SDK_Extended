...
struct DenseInputWithFeatures_
{
  ...
  _max_depth_type max_depth;
   ...
   typedef std::vector< ::svo_msgs::Feature_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::svo_msgs::Feature_<ContainerAllocator> >> _features_type;
