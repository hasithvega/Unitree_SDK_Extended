...
static const _PandarPacket_type_support_symbol_names_t _PandarPacket_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, hesai_lidar, msg, PandarPacket)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, hesai_lidar, msg, PandarPacket)),
  }
};
...
{
  return &::hesai_lidar::msg::rosidl_typesupport_cpp::PandarPacket_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, hesai_lidar, msg, PandarPacket)() {
  return get_message_type_support_handle<hesai_lidar::msg::PandarPacket>();
}
