...
#include <stddef.h>
#include "unitree_interfaces/msg/detail/imu__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  unitree_interfaces__msg__IMU__init(message_memory);
}

void IMU__rosidl_typesupport_introspection_c__IMU_fini_function(void * message_memory)
{
  unitree_interfaces__msg__IMU__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember IMU__rosidl_typesupport_introspection_c__IMU_message_member_array[4] = {
  {
    ...
    offsetof(unitree_interfaces__msg__IMU, quaternion),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    3,  // array size
    false,  // is upper bound
    offsetof(unitree_interfaces__msg__IMU, gyroscope),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    3,  // array size
    false,  // is upper bound
    offsetof(unitree_interfaces__msg__IMU, accelerometer),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(unitree_interfaces__msg__IMU, temperature),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers IMU__rosidl_typesupport_introspection_c__IMU_message_members = {
  ...
  "IMU",  // message name
  4,  // number of fields
  sizeof(unitree_interfaces__msg__IMU),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, unitree_interfaces, msg, IMU)() {
