...
bool hesai_lidar__msg__pandar_packet__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("hesai_lidar.msg._pandar_packet.PandarPacket", full_classname_dest, 43) == 0);
  }
  hesai_lidar__msg__PandarPacket * ros_message = _ros_message;
  {  // stamp
...
PyObject * hesai_lidar__msg__pandar_packet__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("hesai_lidar.msg._pandar_packet");
