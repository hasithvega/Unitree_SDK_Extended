...
bool lio_sam_ros2__msg__cloud_info__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("lio_sam_ros2.msg._cloud_info.CloudInfo", full_classname_dest, 38) == 0);
  }
  lio_sam_ros2__msg__CloudInfo * ros_message = _ros_message;
  {  // header
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * lio_sam_ros2__msg__cloud_info__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of CloudInfo */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("lio_sam_ros2.msg._cloud_info");
  ...
  lio_sam_ros2__msg__CloudInfo * ros_message = (lio_sam_ros2__msg__CloudInfo *)raw_ros_message;
  {  // header
    PyObject * field = NULL;
