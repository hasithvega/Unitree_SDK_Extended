...
#include "hesai_lidar/msg/rosidl_typesupport_c__visibility_control.h"
...
static const _PandarPacket_type_support_symbol_names_t _PandarPacket_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, hesai_lidar, msg, PandarPacket)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, hesai_lidar, msg, PandarPacket)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_hesai_lidar
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, hesai_lidar, msg, PandarPacket)() {
  return &::hesai_lidar::msg::rosidl_typesupport_c::PandarPacket_message_type_support_handle;
}
