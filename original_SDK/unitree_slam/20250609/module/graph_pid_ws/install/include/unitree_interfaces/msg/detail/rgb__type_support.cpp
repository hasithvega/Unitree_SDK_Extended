...
{
  new (message_memory) unitree_interfaces::msg::Rgb(_init);
}

void Rgb_fini_function(void * message_memory)
{
  auto typed_message = static_cast<unitree_interfaces::msg::Rgb *>(message_memory);
  typed_message->~Rgb();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Rgb_message_member_array[3] = {
  {
    ...
    offsetof(unitree_interfaces::msg::Rgb, r),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(unitree_interfaces::msg::Rgb, g),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(unitree_interfaces::msg::Rgb, b),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Rgb_message_members = {
  ...
  "Rgb",  // message name
  3,  // number of fields
  sizeof(unitree_interfaces::msg::Rgb),
...
get_message_type_support_handle<unitree_interfaces::msg::Rgb>()
{
  return &::unitree_interfaces::msg::rosidl_typesupport_introspection_cpp::Rgb_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, unitree_interfaces, msg, Rgb)() {
  return &::unitree_interfaces::msg::rosidl_typesupport_introspection_cpp::Rgb_message_type_support_handle;
}
