...
#ifndef UNITREE_INTERFACES__MSG__DETAIL__IMU__STRUCT_HPP_
#define UNITREE_INTERFACES__MSG__DETAIL__IMU__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__unitree_interfaces__msg__IMU __attribute__((deprecated))
#else
# define DEPRECATED__unitree_interfaces__msg__IMU __declspec(deprecated)
#endif
...
struct IMU_
{
  ...
  // pointer types
  using RawPtr =
    unitree_interfaces::msg::IMU_<ContainerAllocator> *;
  using ConstRawPtr =
    const unitree_interfaces::msg::IMU_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<unitree_interfaces::msg::IMU_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<unitree_interfaces::msg::IMU_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      unitree_interfaces::msg::IMU_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<unitree_interfaces::msg::IMU_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<unitree_interfaces::msg::IMU_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<unitree_interfaces::msg::IMU_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<unitree_interfaces::msg::IMU_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__unitree_interfaces__msg__IMU
    std::shared_ptr<unitree_interfaces::msg::IMU_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__unitree_interfaces__msg__IMU
    std::shared_ptr<unitree_interfaces::msg::IMU_<ContainerAllocator> const>
...
using IMU =
  unitree_interfaces::msg::IMU_<std::allocator<void>>;
...
#endif  // UNITREE_INTERFACES__MSG__DETAIL__IMU__STRUCT_HPP_
