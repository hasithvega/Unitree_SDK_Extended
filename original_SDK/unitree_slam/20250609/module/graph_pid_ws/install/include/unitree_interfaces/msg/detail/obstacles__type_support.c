...
#include <stddef.h>
#include "unitree_interfaces/msg/detail/obstacles__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  unitree_interfaces__msg__Obstacles__init(message_memory);
}

void Obstacles__rosidl_typesupport_introspection_c__Obstacles_fini_function(void * message_memory)
{
  unitree_interfaces__msg__Obstacles__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember Obstacles__rosidl_typesupport_introspection_c__Obstacles_message_member_array[1] = {
  {
    "obstacle",  // name
    ...
    offsetof(unitree_interfaces__msg__Obstacles, obstacle),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers Obstacles__rosidl_typesupport_introspection_c__Obstacles_message_members = {
  ...
  1,  // number of fields
  sizeof(unitree_interfaces__msg__Obstacles),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, unitree_interfaces, msg, Obstacles)() {
