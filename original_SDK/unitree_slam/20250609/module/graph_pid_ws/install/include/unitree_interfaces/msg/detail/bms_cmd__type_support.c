...
#include <stddef.h>
#include "unitree_interfaces/msg/detail/bms_cmd__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  unitree_interfaces__msg__BmsCmd__init(message_memory);
}

void BmsCmd__rosidl_typesupport_introspection_c__BmsCmd_fini_function(void * message_memory)
{
  unitree_interfaces__msg__BmsCmd__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember BmsCmd__rosidl_typesupport_introspection_c__BmsCmd_message_member_array[1] = {
  {
    "off",  // name
    ...
    offsetof(unitree_interfaces__msg__BmsCmd, off),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers BmsCmd__rosidl_typesupport_introspection_c__BmsCmd_message_members = {
  ...
  "BmsCmd",  // message name
  1,  // number of fields
  sizeof(unitree_interfaces__msg__BmsCmd),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, unitree_interfaces, msg, BmsCmd)() {
