...
bool unitree_interfaces__msg__gait_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("unitree_interfaces.msg._gait_state.GaitState", full_classname_dest, 44) == 0);
  }
  unitree_interfaces__msg__GaitState * ros_message = _ros_message;
  {  // mode
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * unitree_interfaces__msg__gait_state__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of GaitState */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("unitree_interfaces.msg._gait_state");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "GaitState");
  ...
  unitree_interfaces__msg__GaitState * ros_message = (unitree_interfaces__msg__GaitState *)raw_ros_message;
  {  // mode
    PyObject * field = NULL;
