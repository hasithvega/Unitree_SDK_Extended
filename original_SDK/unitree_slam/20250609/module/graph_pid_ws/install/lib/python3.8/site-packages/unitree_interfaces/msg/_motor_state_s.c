...
bool unitree_interfaces__msg__motor_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("unitree_interfaces.msg._motor_state.MotorState", full_classname_dest, 46) == 0);
  }
  unitree_interfaces__msg__MotorState * ros_message = _ros_message;
  {  // mode
  ...
  {  // torque_estimated
    PyObject * field = PyObject_GetAttrString(_pymsg, "torque_estimated");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->torque_estimated = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // q_raw
...
PyObject * unitree_interfaces__msg__motor_state__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("unitree_interfaces.msg._motor_state");
  ...
  unitree_interfaces__msg__MotorState * ros_message = (unitree_interfaces__msg__MotorState *)raw_ros_message;
  {  // mode
    PyObject * field = NULL;
  ...
  {  // torque_estimated
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->torque_estimated);
    {
      int rc = PyObject_SetAttrString(_pymessage, "torque_estimated", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
