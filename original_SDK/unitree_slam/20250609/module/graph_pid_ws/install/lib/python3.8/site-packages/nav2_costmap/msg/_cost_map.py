...
class Metaclass_CostMap(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('nav2_costmap')
        except ImportError:
            import logging
            import traceback
            logger = logging.getLogger(
                'nav2_costmap.msg.CostMap')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__cost_map
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__cost_map
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__cost_map
            cls._TYPE_SUPPORT = module.type_support_msg__msg__cost_map
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__cost_map
