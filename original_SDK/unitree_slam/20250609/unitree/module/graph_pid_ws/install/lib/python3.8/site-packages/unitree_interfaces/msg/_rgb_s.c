...
bool unitree_interfaces__msg__rgb__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("unitree_interfaces.msg._rgb.Rgb", full_classname_dest, 31) == 0);
  }
  unitree_interfaces__msg__Rgb * ros_message = _ros_message;
  {  // r
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * unitree_interfaces__msg__rgb__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of Rgb */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("unitree_interfaces.msg._rgb");
  ...
  unitree_interfaces__msg__Rgb * ros_message = (unitree_interfaces__msg__Rgb *)raw_ros_message;
  {  // r
    PyObject * field = NULL;
