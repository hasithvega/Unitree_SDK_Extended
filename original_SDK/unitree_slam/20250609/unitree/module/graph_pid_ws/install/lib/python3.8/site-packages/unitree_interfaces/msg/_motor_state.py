    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'unitree_interfaces.msg.MotorState')
            logger.debug(
...
class MotorState(metaclass=Metaclass_MotorState):
    ...
    def __init__(self, **kwargs):
        ...
        self.torque_estimated = kwargs.get('torque_estimated', float())
    ...
    def __eq__(self, other):
        ...
        if self.ddq != other.ddq:
            return False
        if self.torque_estimated != other.torque_estimated:
            return False
    ...
    @property
    def torque_estimated(self):
        """Message field 'torque_estimated'."""
        return self._torque_estimated

    @torque_estimated.setter
    def torque_estimated(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'torque_estimated' field must be of type 'float'"
        self._torque_estimated = value
