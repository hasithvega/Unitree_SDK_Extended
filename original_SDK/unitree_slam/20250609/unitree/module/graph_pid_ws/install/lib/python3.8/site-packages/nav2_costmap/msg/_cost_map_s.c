...
bool nav2_costmap__msg__cost_map__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("nav2_costmap.msg._cost_map.CostMap", full_classname_dest, 34) == 0);
  }
  nav2_costmap__msg__CostMap * ros_message = _ros_message;
  {  // header
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * nav2_costmap__msg__cost_map__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of CostMap */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("nav2_costmap.msg._cost_map");
  ...
  nav2_costmap__msg__CostMap * ros_message = (nav2_costmap__msg__CostMap *)raw_ros_message;
  {  // header
    PyObject * field = NULL;
