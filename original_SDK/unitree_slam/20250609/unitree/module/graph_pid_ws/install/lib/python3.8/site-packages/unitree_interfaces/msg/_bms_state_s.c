...
bool unitree_interfaces__msg__bms_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("unitree_interfaces.msg._bms_state.BmsState", full_classname_dest, 42) == 0);
  }
  unitree_interfaces__msg__BmsState * ros_message = _ros_message;
  {  // soc
  ...
  {  // cell_voltage
    ...
    }
    {
      ...
      Py_ssize_t size = 30;
      uint16_t * dest = ros_message->cell_voltage;
      for (Py_ssize_t i = 0; i < size; ++i) {
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * unitree_interfaces__msg__bms_state__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of BmsState */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("unitree_interfaces.msg._bms_state");
  ...
  unitree_interfaces__msg__BmsState * ros_message = (unitree_interfaces__msg__BmsState *)raw_ros_message;
  {  // soc
    PyObject * field = NULL;
  ...
  {  // cell_voltage
    ...
    uint16_t * src = &(ros_message->cell_voltage[0]);
    memcpy(dst, src, 30 * sizeof(uint16_t));
    Py_DECREF(field);
  }
