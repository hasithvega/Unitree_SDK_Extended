...
lio_sam_ros2__msg__CloudInfo__init(lio_sam_ros2__msg__CloudInfo * msg)
{
  ...
  if (!std_msgs__msg__Header__init(&msg->header)) {
    lio_sam_ros2__msg__CloudInfo__fini(msg);
    return false;
  }
  // start_ring_index
...
lio_sam_ros2__msg__CloudInfo__create()
{
  ...
  lio_sam_ros2__msg__CloudInfo * msg = (lio_sam_ros2__msg__CloudInfo *)allocator.allocate(sizeof(lio_sam_ros2__msg__CloudInfo), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(lio_sam_ros2__msg__CloudInfo));
  bool success = lio_sam_ros2__msg__CloudInfo__init(msg);
  if (!success) {
...
lio_sam_ros2__msg__CloudInfo__Sequence__init(lio_sam_ros2__msg__CloudInfo__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  lio_sam_ros2__msg__CloudInfo * data = NULL;

  if (size) {
    data = (lio_sam_ros2__msg__CloudInfo *)allocator.zero_allocate(size, sizeof(lio_sam_ros2__msg__CloudInfo), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = lio_sam_ros2__msg__CloudInfo__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        lio_sam_ros2__msg__CloudInfo__fini(&data[i - 1]);
      }
...
lio_sam_ros2__msg__CloudInfo__Sequence__fini(lio_sam_ros2__msg__CloudInfo__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      lio_sam_ros2__msg__CloudInfo__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  lio_sam_ros2__msg__CloudInfo__Sequence * array = (lio_sam_ros2__msg__CloudInfo__Sequence *)allocator.allocate(sizeof(lio_sam_ros2__msg__CloudInfo__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = lio_sam_ros2__msg__CloudInfo__Sequence__init(array, size);
  if (!success) {
...
lio_sam_ros2__msg__CloudInfo__Sequence__destroy(lio_sam_ros2__msg__CloudInfo__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    lio_sam_ros2__msg__CloudInfo__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
lio_sam_ros2__msg__CloudInfo__Sequence__are_equal(const lio_sam_ros2__msg__CloudInfo__Sequence * lhs, const lio_sam_ros2__msg__CloudInfo__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!lio_sam_ros2__msg__CloudInfo__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  lio_sam_ros2__msg__CloudInfo__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(lio_sam_ros2__msg__CloudInfo);
    lio_sam_ros2__msg__CloudInfo * data =
      (lio_sam_ros2__msg__CloudInfo *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!lio_sam_ros2__msg__CloudInfo__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          lio_sam_ros2__msg__CloudInfo__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!lio_sam_ros2__msg__CloudInfo__copy(
