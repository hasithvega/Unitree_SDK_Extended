...
#include <stddef.h>
#include "unitree_interfaces/msg/detail/bms_state__rosidl_typesupport_introspection_c.h"
...
#include "unitree_interfaces/msg/detail/bms_state__struct.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  unitree_interfaces__msg__BmsState__init(message_memory);
}

void BmsState__rosidl_typesupport_introspection_c__BmsState_fini_function(void * message_memory)
{
  unitree_interfaces__msg__BmsState__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember BmsState__rosidl_typesupport_introspection_c__BmsState_message_member_array[6] = {
  {
    "soc",  // name
    ...
    offsetof(unitree_interfaces__msg__BmsState, soc),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(unitree_interfaces__msg__BmsState, current),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(unitree_interfaces__msg__BmsState, cycle),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    8,  // array size
    false,  // is upper bound
    offsetof(unitree_interfaces__msg__BmsState, bq_ntc),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    8,  // array size
    false,  // is upper bound
    offsetof(unitree_interfaces__msg__BmsState, mcu_ntc),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    30,  // array size
    false,  // is upper bound
    offsetof(unitree_interfaces__msg__BmsState, cell_voltage),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers BmsState__rosidl_typesupport_introspection_c__BmsState_message_members = {
  ...
  6,  // number of fields
  sizeof(unitree_interfaces__msg__BmsState),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, unitree_interfaces, msg, BmsState)() {
