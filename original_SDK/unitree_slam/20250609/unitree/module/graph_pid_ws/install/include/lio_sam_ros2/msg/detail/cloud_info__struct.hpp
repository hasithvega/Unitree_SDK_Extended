...
#ifndef LIO_SAM_ROS2__MSG__DETAIL__CLOUD_INFO__STRUCT_HPP_
#define LIO_SAM_ROS2__MSG__DETAIL__CLOUD_INFO__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__lio_sam_ros2__msg__CloudInfo __attribute__((deprecated))
#else
# define DEPRECATED__lio_sam_ros2__msg__CloudInfo __declspec(deprecated)
#endif
...
struct CloudInfo_
{
  ...
  // pointer types
  using RawPtr =
    lio_sam_ros2::msg::CloudInfo_<ContainerAllocator> *;
  using ConstRawPtr =
    const lio_sam_ros2::msg::CloudInfo_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<lio_sam_ros2::msg::CloudInfo_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<lio_sam_ros2::msg::CloudInfo_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      lio_sam_ros2::msg::CloudInfo_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<lio_sam_ros2::msg::CloudInfo_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<lio_sam_ros2::msg::CloudInfo_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<lio_sam_ros2::msg::CloudInfo_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<lio_sam_ros2::msg::CloudInfo_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__lio_sam_ros2__msg__CloudInfo
    std::shared_ptr<lio_sam_ros2::msg::CloudInfo_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__lio_sam_ros2__msg__CloudInfo
    std::shared_ptr<lio_sam_ros2::msg::CloudInfo_<ContainerAllocator> const>
...
using CloudInfo =
  lio_sam_ros2::msg::CloudInfo_<std::allocator<void>>;
...
#endif  // LIO_SAM_ROS2__MSG__DETAIL__CLOUD_INFO__STRUCT_HPP_
